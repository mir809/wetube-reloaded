...
const noneComments = document.querySelector(".none_comments");

const handleNoneComments = () => {
  // 댓글 0개 일경우 '댓글 없음' 표시 / 1개라도 있으면 안보이게
  if (commentsNumber === 0) {
    noneComments.classList.remove("hidden");
  } else {
    noneComments.classList.add("hidden");
  }
};
